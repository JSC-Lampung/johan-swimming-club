                ...
                <div className="p-6 border-b border-slate-700/50">
                    <Link href="/coach" className="flex items-center gap-3 group/logo">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="text-blue-400 text-[9px] font-black uppercase tracking-[0.2em] mt-1">Portal Pelatih</p>
                        </div>
                    </Link>
                </div>
                ...
                <div className="p-4 border-t border-slate-700 bg-slate-800/80 mt-auto">
                    ...
                    <div className="flex items-center gap-3 bg-slate-900/40 p-3 rounded-2xl border border-slate-700/30 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h2 className="text-white font-bold text-[11px] truncate whitespace-nowrap">{user?.full_name || 'Pelatih JSC'}</h2>
